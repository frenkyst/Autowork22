...
public class HomeBossFragment extends Fragment {
    ...
    public HomeBossFragment() {
        // Required empty public constructor
    }

    private DatabaseReference database;

    private ArrayList<UserMan> daftarReq;
    private MemintaUserManboss memintausermanboss;
        ...
        database.child("TOKO 1").child("UserMan").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot noteDataSnapshot : dataSnapshot.getChildren()) {
                     ...
                     */
                    UserMan requests = noteDataSnapshot.getValue(UserMan.class);
                 ...
                 */
                memintausermanboss = new MemintaUserManboss(daftarReq, getActivity());
                rc_list_request.setAdapter(memintausermanboss);
                loading.dismiss();
            }
